...
export default function StockIssue({ language }) {
  ...
  const [issues, setIssues] = useState([
    { id: 1, voucherNo: 'SV-2025-001', item: 'أرز', quantity: 50, unit: 'كيس', recipient: 'المطبخ الرئيسي', purpose: 'استهلاك يومي لوجبات النزلاء', date: '2025-11-20', status: 'approved' },
    { id: 2, voucherNo: 'SV-2025-002', item: 'منظف أرضيات', quantity: 30, unit: 'قارورة', recipient: 'قسم النظافة', purpose: 'تنظيف الممرات والغرف', date: '2025-11-20', status: 'approved' },
    { id: 3, voucherNo: 'SV-2025-003', item: 'مناشف', quantity: 100, unit: 'قطعة', recipient: 'قسم الغرف', purpose: 'تجهيز الغرف للنزلاء', date: '2025-11-21', status: 'pending' },
    { id: 4, voucherNo: 'SV-2025-004', item: 'صابون', quantity: 200, unit: 'قطعة', recipient: 'قسم النظافة', purpose: 'تزويد الحمامات', date: '2025-11-21', status: 'approved' },
    { id: 5, voucherNo: 'SV-2025-005', item: 'ورق تواليت', quantity: 150, unit: 'لفة', recipient: 'قسم الغرف', purpose: 'تزويد غرف النزلاء', date: '2025-11-21', status: 'pending' }
  ])
