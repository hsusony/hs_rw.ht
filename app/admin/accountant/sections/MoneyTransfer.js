...
export default function MoneyTransfer({ language }) {
  ...
  const [transfers, setTransfers] = useState([
    { id: 1, fromFund: 'صندوق الريسبشن', toFund: 'البنك المركزي', amount: 15000000, date: '2025-11-20', notes: 'إيداع إيرادات يومية', status: 'completed' },
    { id: 2, fromFund: 'البنك المركزي', toFund: 'صندوق الرواتب', amount: 12000000, date: '2025-11-19', notes: 'تحويل لدفع رواتب الموظفين', status: 'completed' },
    { id: 3, fromFund: 'صندوق الريسبشن', toFund: 'صندوق المصروفات', amount: 3500000, date: '2025-11-20', notes: 'تمويل مصروفات تشغيلية', status: 'completed' },
    { id: 4, fromFund: 'بطاقة فيزا', toFund: 'البنك المركزي', amount: 8000000, date: '2025-11-21', notes: 'تحصيل مدفوعات بطاقات الائتمان', status: 'completed' },
    { id: 5, fromFund: 'البنك المركزي', toFund: 'صندوق المصروفات', amount: 5000000, date: '2025-11-21', notes: 'تمويل احتياجات الفندق الأسبوعية', status: 'completed' }
  ])
