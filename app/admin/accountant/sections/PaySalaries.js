...
export default function PaySalaries({ language }) {
  const [employees, setEmployees] = useState([
    { id: 1, nameAr: 'أحمد محمد الحسيني', nameEn: 'Ahmed Mohammed Al-Husseini', role: 'مدير الاستقبال', salary: 2500000, month: 'نوفمبر 2025', paid: true },
    { id: 2, nameAr: 'فاطمة علي السعدي', nameEn: 'Fatima Ali Al-Saadi', role: 'مسؤولة النظافة', salary: 1800000, month: 'نوفمبر 2025', paid: false },
    { id: 3, nameAr: 'محمود حسن الكاظمي', nameEn: 'Mahmoud Hassan Al-Kadhimi', role: 'رئيس الطهاة', salary: 2800000, month: 'نوفمبر 2025', paid: true },
    { id: 4, nameAr: 'سارة عبدالله الجبوري', nameEn: 'Sara Abdullah Al-Jubouri', role: 'موظفة استقبال', salary: 1500000, month: 'نوفمبر 2025', paid: false },
    { id: 5, nameAr: 'عمر يوسف البصري', nameEn: 'Omar Youssef Al-Basri', role: 'فني صيانة', salary: 2000000, month: 'نوفمبر 2025', paid: false },
    { id: 6, nameAr: 'زينب صالح النجفي', nameEn: 'Zainab Saleh Al-Najafi', role: 'مديرة التدبير المنزلي', salary: 2200000, month: 'نوفمبر 2025', paid: true },
    { id: 7, nameAr: 'كريم فاضل الموصلي', nameEn: 'Kareem Fadhel Al-Mosuli', role: 'موظف أمن', salary: 1700000, month: 'نوفمبر 2025', paid: false }
  ])
