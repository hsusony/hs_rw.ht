...
export default function PurchaseInvoice({ language }) {
  ...
  const [invoices, setInvoices] = useState([
    { id: 1, invoiceNo: 'PI-2025-001', supplier: 'شركة الأطياف للمواد الغذائية', items: 8, total: 5750000, date: '2025-11-18', status: 'paid' },
    { id: 2, invoiceNo: 'PI-2025-002', supplier: 'مؤسسة النظافة المثالية', items: 12, total: 3200000, date: '2025-11-19', status: 'paid' },
    { id: 3, invoiceNo: 'PI-2025-003', supplier: 'معرض الأثاث الراقي', items: 5, total: 8500000, date: '2025-11-20', status: 'pending' },
    { id: 4, invoiceNo: 'PI-2025-004', supplier: 'شركة الكهرباء والإلكترونيات', items: 15, total: 4300000, date: '2025-11-20', status: 'pending' },
    { id: 5, invoiceNo: 'PI-2025-005', supplier: 'مخابز الفجر الذهبي', items: 6, total: 1800000, date: '2025-11-21', status: 'paid' }
  ])
