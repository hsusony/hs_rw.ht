...
export default function InventoryItems({ language }) {
  ...
  const [items, setItems] = useState([
    {
      id: 1,
      nameAr: 'أرز بسمتي درجة أولى',
      nameEn: 'Premium Basmati Rice',
      unit: 'كيس 25 كغم',
      openingBalance: 250,
      currentBalance: 180,
      reorderLevel: 60,
      warehouse: 'مخزن المواد الغذائية'
    },
    {
      id: 2,
      nameAr: 'منظف أرضيات مركز - نوع ممتاز',
      nameEn: 'Premium Concentrated Floor Cleaner',
      unit: 'قارورة 5 لتر',
      openingBalance: 120,
      currentBalance: 85,
      reorderLevel: 35,
      warehouse: 'مخزن مواد النظافة'
    },
    {
      id: 3,
      nameAr: 'مناشف قطنية بيضاء - حجم كبير',
      nameEn: 'Large White Cotton Towels',
      unit: 'قطعة',
      openingBalance: 1000,
      currentBalance: 750,
      reorderLevel: 250,
      warehouse: 'مخزن الأثاث والمفروشات'
    }
  ])
