...
export default function Warehouses({ language }) {
  ...
  const [warehouses, setWarehouses] = useState([
    {
      id: 1,
      nameAr: 'مخزن المواد الغذائية',
      nameEn: 'Food Storage',
      location: 'الطابق السفلي - الجناح الشرقي',
      capacity: 5000,
      currentStock: 3500,
      manager: 'محمد أحمد الخزان',
      status: 'active'
    },
    {
      id: 2,
      nameAr: 'مخزن مواد النظافة',
      nameEn: 'Cleaning Supplies Storage',
      location: 'الطابق الأرضي - الجناح الغربي',
      capacity: 3000,
      currentStock: 2400,
      manager: 'فاطمة حسين المخزنجي',
      status: 'active'
    },
    {
      id: 3,
      nameAr: 'مخزن الأثاث والمفروشات',
      nameEn: 'Furniture Storage',
      location: 'المبنى الخلفي - الطابق الأول',
      capacity: 2000,
      currentStock: 1500,
      manager: 'عبدالله سالم النجار',
      status: 'active'
    }
  ])
